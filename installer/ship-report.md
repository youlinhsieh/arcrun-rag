...
來源（stage）＝Arcrun@3eb8b31f2bfa　｜　來源（prod）＝Arcrun@3eb8b31f2bfa
...
真的做事的站：stage 11／19 站（上次 16 站）　｜　prod 9／19 站（與上次相同）
...
⬜ 跳過的站（15 筆）——**這一欄要自己看過**：「登錄簿宣告本目標沒這東西」與「已經是這一版、沒事可做」是正常，其他都要當成漏做：
   ...
   · prod｜pin：釘子已是 4424451（built 2026-08-12），不需要動
   · prod｜deploy：線上已是 1.4.38／pin 4424451，且釘子沒動 ⇒ 不重複部署
